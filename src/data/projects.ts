...
export const projectsBySlug: Record<string, ProjectDetailModel> = {
  ...
  forseason: {
    ...
    items: [
      ...
      { name: "Bukkit", src: "/icons/bukkit.png" },
  ...
  chaostnt: {
    ...
    description: [
      ...
      "Le projet repose sur une architecture modulaire organisée autour de services dédiés, permettant de gérer indépendamment les arènes, les commandes, les menus, les statistiques, les items personnalisés et les différentes mécaniques de jeu.",
      "Le plugin intègre plusieurs systèmes gameplay avancés, notamment la gestion d’arènes, des phases de prison et de freeze avec timers, téléportations et effets temporaires, ainsi que des mécaniques personnalisées autour de la TNT, des boucliers et de la pose rapide de blocs.",
      "Des fonctionnalités communautaires ont également été développées, comme un système de podium dynamique pour les donateurs avec skins personnalisés.",
      "Une partie du développement a porté sur la mise en place d’une configuration dynamique synchronisée avec une base de données MySQL et une interface web externe, permettant de piloter certains paramètres du plugin en temps réel.",
      "Ce projet m’a permis de concevoir une architecture complète reliant gameplay temps réel, base de données distante et outils web de configuration, dans un environnement multijoueur événementiel."
    ],

    items: [
      { name: "Java", src: "/icons/java.png" },
      { name: "Maven", src: "/icons/maven.png" },
      { name: "MySQL", icon: "mysql", color: "4479A1" },
      { name: "Bukkit", src: "/icons/bukkit.png" },
      { name: "Papermc", src: "/icons/papermc.png" },
      { name: "Pterodactyl", src: "/icons/pterodactyl.png" },
      { name: "Tik360", src: "/icons/tik360.png" },
      { name: "Git", icon: "git", color: "F05032" },
      { name: "Linux", icon: "linux", color: "020e21" },
    ],
    links: [
